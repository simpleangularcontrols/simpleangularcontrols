...
{
    [TaskName("GitUpdateDoc")]
    [TaskDescription("Commit Updated Documentation to Repository")]
    public class GitUpdateDoc : FrostingTask<BuildContext>
    {
        public override void Run(BuildContext context)
        {
            ...
            GitCommand(context, $"add -A {context.Environment.WorkingDirectory.Combine(new DirectoryPath(context.DirectoryDoc)).FullPath}/**/*.*");

            context.Information("Commit Doc");
            GitCommand(context, $"commit -m \"chore: Update Documentation\"");
