...
describe('NgInputDecimalComponent', () => {
  it('should show label and text', () => {
    cy.mount(
      `<form>
      <ngInputDecimal name="field" [label]="label" [ngModel]="value" (ngModelChange)="valueChange.emit($event)">
      </ngInputDecimal>
      </form>`,
      {
  ...
  it('should show required', () => {
    cy.mount(
      `<form>
      <ngInputDecimal name="field" [label]="label" [isrequired]="true" [ngModel]="value" (ngModelChange)="valueChange.emit($event)">
      </ngInputDecimal>
      </form>`,
      {
        declarations: [NgFormularDirective, NgInputDecimalComponent],
  ...
  it('should hide label', () => {
    cy.mount(
      `<form>
      <ngInputDecimal name="field" [label]="label" [disablelabel]="true" [ngModel]="value" (ngModelChange)="valueChange.emit($event)">
      </ngInputDecimal>
      </form>`,
      {
        declarations: [NgFormularDirective, NgInputDecimalComponent],
  ...
  it('should have placeholder', () => {
    cy.mount(
      `<form>
      <ngInputDecimal name="field" [label]="label" placeholder="My Placeholder" [ngModel]="value" (ngModelChange)="valueChange.emit($event)">
      </ngInputDecimal>
      </form>`,
      {
        declarations: [NgFormularDirective, NgInputDecimalComponent],
  ...
  it('should have be readonly', () => {
    cy.mount(
      `<form>
      <ngInputDecimal name="field" [label]="label" [readonly]="true" [ngModel]="value" (ngModelChange)="valueChange.emit($event)">
      </ngInputDecimal>
      </form>`,
      {
        declarations: [NgFormularDirective, NgInputDecimalComponent],
  ...
  it('should have be disabled', () => {
    cy.mount(
      `<form>
      <ngInputDecimal name="field" [label]="label" [disabled]="true" [ngModel]="value" (ngModelChange)="valueChange.emit($event)">
      </ngInputDecimal>
      </form>`,
      {
        declarations: [NgFormularDirective, NgInputDecimalComponent],
  ...
  it('should use maxvalue', () => {
    cy.mount(
      `<form>
      <ngInputDecimal name="field" [label]="label" [maxvalue]="6" [ngModel]="value" (ngModelChange)="valueChange.emit($event)">
      </ngInputDecimal>
      </form>`,
      {
        declarations: [NgFormularDirective, NgInputDecimalComponent],
  ...
  it('should use minvalue', () => {
    cy.mount(
      `<form>
      <ngInputDecimal name="field" [label]="label" [minvalue]="6" [ngModel]="value" (ngModelChange)="valueChange.emit($event)">
      </ngInputDecimal>
      </form>`,
      {
        declarations: [NgFormularDirective, NgInputDecimalComponent],
  ...
  it('should allow negativ numbers', () => {
    cy.mount(
      `<form>
      <ngInputDecimal name="field" [label]="label" [allownegativ]="true" [ngModel]="value" (ngModelChange)="valueChange.emit($event)">
      </ngInputDecimal>
      </form>`,
      {
        declarations: [NgFormularDirective, NgInputDecimalComponent],
  ...
  it('should allow only positiv numbers', () => {
    cy.mount(
      `<form>
      <ngInputDecimal name="field" [label]="label" [allownegativ]="false" [ngModel]="value" (ngModelChange)="valueChange.emit($event)">
      </ngInputDecimal>
      </form>`,
      {
        declarations: [NgFormularDirective, NgInputDecimalComponent],
