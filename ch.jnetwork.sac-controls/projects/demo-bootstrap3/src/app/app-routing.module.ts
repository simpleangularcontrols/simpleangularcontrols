...
const routes: Routes = [
    ...
    {
        path: 'reactiveform',
        loadChildren: () => import('./formreactive/reactiveform.module').then((m) => m.ReactiveFormModule),
    },
    {
        path: 'checkbox',
    ...
    {
        path: 'datetime',
        loadChildren: () => import('./datetime/datetime.module').then((m) => m.DatetimeModule),
    },
    {
        path: 'list',
    ...
    {
        path: 'multilanguage',
        loadChildren: () => import('./multilanguage/multilanguage.module').then((m) => m.MultilanguageModule),
    },
    {
        path: 'tooltip',
    ...
    {
        path: 'contextmenu',
        loadChildren: () => import('./contextmenu/contextmenu.module').then((m) => m.ContextmenuModule),
    },
    {
        path: 'treeview',
