...
@Component({
    ...
    standalone: true,
    imports: [NgIf, NgClass, CommonModule, SacTestingAttributePipe],
    styles: [
        'sac-button+sac-button {margin-left: 5px}',
        '.spin { animation: spin 1.5s infinite; } @keyframes spin { 0% { transform: rotate(0); } 100% { transform: rotate(360deg); } }',
    ], // Workaround: Abstand zwischen 2 Buttons setzen, da Boostrap3 nicht mit Host Items umgehen kann
