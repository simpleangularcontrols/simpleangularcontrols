...
describe('SacDateTimeComponent', () => {
    it('should show label and component', () => {
        cy.mount(
            ...
            {
                imports: [FormsModule, SacFormDirective, SacDateTimeComponent, SACBootstrap3LayoutModule],
                componentProperties: {
                    label: 'My Label',
                },
            }
    ...
    it('should reset date via selector with reactive forms', () => {
        ...
        cy.mount(
            ...
            {
                imports: [ReactiveFormsModule, SacFormDirective, SacDateTimeComponent, SACBootstrap3LayoutModule],
                componentProperties: {
                    label: 'My Label',
                    value: form,
                    valueChange: createOutputSpy('valueSpy'),
