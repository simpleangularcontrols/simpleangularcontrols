...
describe('SacTimeComponent', () => {
    it('should show label and component', () => {
        cy.mount(
            ...
            {
                imports: [FormsModule, SacFormDirective, SacTimeComponent, SACBootstrap3LayoutModule],
                componentProperties: {
                    label: 'My Label',
                },
            }
    ...
    it('should reset time via selector with reactive forms', () => {
        ...
        cy.mount(
            ...
            {
                imports: [ReactiveFormsModule, SacFormDirective, SacTimeComponent, SACBootstrap3LayoutModule],
                componentProperties: {
                    label: 'My Label',
                    value: form,
                    valueChange: createOutputSpy('valueSpy'),
