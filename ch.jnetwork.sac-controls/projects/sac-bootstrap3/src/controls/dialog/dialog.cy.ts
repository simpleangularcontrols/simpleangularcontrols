...
import { SACBootstrap3DialogModule } from './dialog.module';
...
describe('SacDialogComponent', () => {
    it('should show component', () => {
        cy.mount(
            ...
            {
                declarations: [SacFormDirective, SacButtonComponent],
                imports: [FormsModule, SACBootstrap3DialogModule, SACBootstrap3LayoutModule, SACCommonUtliltiesModule],
                componentProperties: {},
            }
        );
