...
import { SACBootstrap3GridModule } from './grid.module';
import { FormsModule } from '@angular/forms';
import { PagerData, PagerRequest, SACCONFIGURATION_SERVICE } from '@simpleangularcontrols/sac-common';
...
describe('SacPagingComponent', () => {
    it('should show label and component', () => {
        ...
        cy.get('div.text-center').should('exist');
    });
    ...
    it('should emit paged event on page change', () => {
        ...
        cy.get('.pagination li a').contains('3').click();
    ...
    it('should emit paged event on click firstPage', () => {
        ...
        cy.get('.pagination li a').first().click();
    ...
    it('should emit paged event on click lastPage', () => {
        ...
        cy.get('.pagination li.active').should('have.text', '3');
        cy.get('.pagination li a').last().click();
    ...
    it.skip('should emit paged event on click nextPage', () => {
        ...
        cy.get('.pagination li.active').should('have.text', '3');
        cy.get('.pagination li a').eq(5).click();
        cy.get('@pageEvent').should('be.calledWith', new PagerRequest(20, 4));
    });
    ...
    it.skip('should emit paged event on click prevPage', () => {
        ...
        cy.get('.pagination li.active').should('have.text', '3');
        cy.get('.pagination li a').eq(1).click();
    ...
    it('should has e2 testkey with name', () => {
        cy.mount(
            `<form>
                <sac-paging name="myControl" [pagerdata]="pagerdata">
                </sac-paging>
            </form>`,
            {
                imports: [FormsModule, SacFormDirective, SACBootstrap3GridModule, SACBootstrap3LayoutModule],
        ...
        cy.shouldHaveTestAttributeWithName('sac-paging > div', 'myControl');
    });

    it('should has e2 testkey with testidentifier when name exists', () => {
        cy.mount(
            `<form>
                <sac-paging name="myControl" e2eidentifier="myTestidentifier" [pagerdata]="pagerdata">
                </sac-paging>
            </form>`,
            {
                imports: [FormsModule, SacFormDirective, SACBootstrap3GridModule, SACBootstrap3LayoutModule],
        ...
        cy.shouldHaveTestAttributeWithName('sac-paging > div', 'myTestidentifier');
    });

    it('should has e2 testkey with testidentifier when name not exists', () => {
        cy.mount(
            `<form>
                <sac-paging e2eidentifier="myTestidentifier" [pagerdata]="pagerdata">
                </sac-paging>
            </form>`,
            {
                imports: [FormsModule, SacFormDirective, SACBootstrap3GridModule, SACBootstrap3LayoutModule],
    ...
    it('should not has e2 testkey with name', () => {
        cy.mount(
            `<form>
                <sac-paging [pagerdata]="pagerdata">
                </sac-paging>
            </form>`,
            {
                imports: [FormsModule, SacFormDirective, SACBootstrap3GridModule, SACBootstrap3LayoutModule],
        ...
        cy.shouldHaveDisabledTestAttribute('sac-paging > div');
    });
});
