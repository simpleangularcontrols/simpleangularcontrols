...
describe('SacDropdownComponent', () => {
    it('should show label and component', () => {
        cy.mount(
            ...
            {
                declarations: [SacFormDirective, SacDropdownComponent, SacDropdownOptionDirective],
                imports: [FormsModule, SACBootstrap3ListModule, SACBootstrap3LayoutModule, SACCommonUtliltiesModule],
                componentProperties: {
                    label: 'My Label',
                },
            }
    ...
    it('should allow numbers as empty value', () => {
        cy.mount(
            ...
            {
                declarations: [SacFormDirective],
                imports: [FormsModule, SACBootstrap3ListModule, SACBootstrap3LayoutModule],
                componentProperties: {
                    label: 'My Label',
                    value: 0,
                },
