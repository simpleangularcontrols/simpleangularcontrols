...
describe('SACBootstrap3TinyMceModule', () => {
    it('should show label and component', () => {
        cy.mount(
            ...
            </form>`,
            {
                ...
                imports: [FormsModule, SACBootstrap3TinyMceModule, SACBootstrap3LayoutModule, SACCommonUtliltiesModule],
                componentProperties: {
                    label: 'My Label',
                    config: {
    ...
    /**
     * files browser is not supported in bs3
     */
    it.skip('should can browse and select image files', () => {
     ...
     * files browser is not supported in bs3
     */
    it.skip('should can browse and select media files', () => {
        cy.intercept('POST', '/api/browser/getnodes', {
            statusCode: 200,
            body: {
                Node: {
     ...
     * files browser is not supported in bs3
     */
    it.skip('should can browse and select link files', () => {
        cy.intercept('POST', '/api/browser/getnodes', {
            statusCode: 200,
            body: {
                Node: {
     ...
     * files browser is not supported in bs3
     */
    it.skip('should can close browse dialog without change content', () => {
        cy.intercept('POST', '/api/browser/getnodes', {
            statusCode: 200,
            body: {
                Node: {
