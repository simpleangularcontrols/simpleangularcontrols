...
import { SACBootstrap3TreeviewModule } from './treeview.module';
...
describe('SacTreeviewComponent', () => {
    it('should show label and component', () => {
        ...
        cy.get('tr[data-path="/1"]').should('have.text', 'Root');
    ...
    it('should have expanded and collapsed icons', () => {
        ...
        cy.get('sac-treeview').should('exist');
        cy.get('tr[data-path="/1"]').should('have.text', 'Root');
        cy.get('tr[data-path="/1/2"]').find('div div').eq(1).should('have.class', 'fa-folder-plus');
        // set focus
        cy.get('tr[data-path="/1/2"] span').click();
        // expand node
        cy.get('tr[data-path="/1/2"] span').click();
        cy.get('tr[data-path="/1/2"]').find('div div').eq(1).should('have.class', 'fa-folder-open');
        cy.get('tr[data-path="/1/3"]').should('have.text', 'Sub Item 2');
    });
    ...
    it('should have action icon', () => {
        ...
        cy.get('tr[data-path="/1/4"] a i').should('not.exist');
        cy.get('tr[data-path="/1/4"] span').click();
        cy.get('tr[data-path="/1/4"] a i').should('exist');
    });
    ...
    it('should not have action icon if disabled with property', () => {
        ...
        cy.get('tr[data-path="/1/3"] a i').should('not.exist');
        cy.get('tr[data-path="/1/3"] span').click();
        cy.get('tr[data-path="/1/3"] a i').should('exist');

        cy.get('tr[data-path="/1/5"] a i').should('not.exist');
        cy.get('tr[data-path="/1/5"] span').click();
        cy.get('tr[data-path="/1/5"] a i').should('exist');
    });
    ...
    it('should emit action event', () => {
        ...
        cy.get('tr[data-path="/1/4"] span').click();
        cy.get('tr[data-path="/1/4"] a i').should('exist');
        cy.get('tr[data-path="/1/4"] a i').click();
    ...
    it('should change selected state on click element', () => {
        ...
        cy.get('tr[data-path="/1/2"]').find('div').eq(2).should('have.class', 'fa-folder-plus');
        cy.get('tr[data-path="/1/2"] span').should('have.text', 'Sub Item 1');

        // Expand Element with empty text
        cy.get('tr[data-path="/1/2"] div.fa-folder-plus').click();
        cy.get('tr[data-path="/1/2"]').should('have.class', 'active');
    });
    ...
    it('should have hover state on hover element', () => {
        ...
        cy.get('tr[data-path="/1/4"] a i').should('not.exist');
        cy.get('tr[data-path="/1/4"]').trigger('mouseenter');
        cy.get('tr[data-path="/1/4"] a i').should('exist');
        cy.get('tr[data-path="/1/4"]').trigger('mouseleave');
        cy.get('tr[data-path="/1/4"] a i').should('not.exist');
    });
    ...
    it('should not have children if attrchildren is not set', () => {
        ...
        cy.get('tr[data-path="/1"] a i').should('not.exist');
        cy.get('tr[data-path="/1"] div span').should('have.text', 'Root');
    });
    ...
    it('should have empty text if label is missing', () => {
        ...
        cy.get('tr[data-path="/1/2"]').find('div').eq(2).should('have.class', 'fa-folder-plus');
        cy.get('tr[data-path="/1/2"] span').should('have.text', '');

        // Set Focus
        // Workaround ... Set hover to fix line size if empty text.
        cy.get('tr[data-path="/1/2"]').trigger('mouseenter');
        cy.get('tr[data-path="/1/2"] div.fa-folder-plus').click();
        cy.get('tr[data-path="/1/2"]').should('have.class', 'active');
        // Exapnd Node
        cy.get('tr[data-path="/1/2"] div.fa-folder-plus').click();
        cy.get('tr[data-path="/1/2/5"]').should('have.text', 'Sub Sub Item 1');
    });
    ...
    it('should have empty text if label field is not set', () => {
        ...
        cy.get('tr[data-path="/1/2"]').find('div').eq(2).should('have.class', 'fa-folder-plus');
        cy.get('tr[data-path="/1/2"] span').should('have.text', '[object Object]');

        // Expand Element with empty text
        cy.get('tr[data-path="/1/2"] div.fa-folder-plus').click();
        cy.get('tr[data-path="/1/2"] div.fa-folder-plus').click();
        cy.get('tr[data-path="/1/2/5"]').should('have.text', '[object Object]');
    });
    ...
    it('should always show action if attrdisableaction not set', () => {
        ...
        // Expand Element with empty text
        cy.get('tr[data-path="/1/2"] div.fa-folder-plus').click();
        cy.get('tr[data-path="/1/2"] a i').should('exist');
    });
    ...
    it('should not allow expanded state if attrexpanded not set', () => {
        ...
        cy.get('tr[data-path="/1/2"]').should('not.exist');

        cy.get('tr[data-path="/1"]').find('div').eq(1).should('have.class', 'fa-folder-plus');
        cy.get('tr[data-path="/1"] span').should('have.text', 'Root');
        cy.get('tr[data-path="/1"] div.fa-folder-plus').click();
        cy.get('tr[data-path="/1"] div.fa-folder-plus').click();
    ...
    it('should not have selected state if attrselected is not set', () => {
        ...
        cy.get('tr[data-path="/1"] div.fa-folder-plus').click();
        cy.get('tr[data-path="/1"] div.fa-folder-plus').click();
        cy.get('tr[data-path="/1"]').should('not.have.class', 'active');
    ...
    it('should not have hover state if attrhoverstate is not set', () => {
        ...
        cy.get('tr[data-path="/1"] div.fa-folder-plus').click();
        cy.get('tr[data-path="/1"] div.fa-folder-plus').click();
        cy.get('tr[data-path="/1"] a i').should('exist');

        // expand is not working if selected state is not configured
        cy.get('tr[data-path="/1/2"]').should('exist');

        cy.get('tr[data-path="/1/2"]').trigger('mouseenter');
        cy.get('tr[data-path="/1/2"] a i').should('not.exist');
        cy.get('tr[data-path="/1/2"]').trigger('mouseleave');
        cy.get('tr[data-path="/1/2"] a i').should('not.exist');
    });
    ...
    it('should work with objects if attrid is not set', () => {
        ...
        cy.get('tr[data-path="/[object Object]').find('div').eq(1).should('have.class', 'fa-folder-plus');
        cy.get('tr[data-path="/[object Object]"] span').should('have.text', 'Root');
        cy.get('tr[data-path="/[object Object]"] div.fa-folder-plus').click();
        cy.get('tr[data-path="/[object Object]"] div.fa-folder-plus').click();

        // expand is not working if selected state is not configured
        cy.get('tr[data-path="/[object Object]/[object Object]"]').eq(0).should('exist');
    });
});
