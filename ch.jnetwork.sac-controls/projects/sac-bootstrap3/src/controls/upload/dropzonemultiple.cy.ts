...
describe('SacDropzoneMultipleComponent', () => {
    ...
    it('should limit files with maxfiles', () => {
        ...
        cy.mount(
            `<form>
                <sac-dropzonemultiple name="uploadControl" maxfiles="1" (onfileerror)="fileerrorAction.emit($event)" endpoint="/api/upload/register" [label]="label"></sac-dropzonemultiple>
            </form>`,
            {
                declarations: [SacFormDirective],
                imports: [FormsModule, SACBootstrap3UploadModule, SACBootstrap3LayoutModule, SACCommonUtliltiesModule],
