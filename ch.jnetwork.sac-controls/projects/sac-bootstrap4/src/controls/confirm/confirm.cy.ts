...
import { SACBootstrap4ConfirmModule } from './confirm.module';
...
describe('ServiceConfirm', () => {
    it('opens dialog via service and returns the clicked button key', () => {
        ...
        cy.mount(HostComponent, {
            ...
            imports: [FormsModule, SACBootstrap4ConfirmModule, SACBootstrap4LayoutModule, SACCommonUtliltiesModule],
            providers: [
                ServiceConfirm,
                {
