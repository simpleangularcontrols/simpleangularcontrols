...
import { SACBootstrap4ContextmenuModule } from './contextmenu.module';
...
describe('SacContextmenuComponent', () => {
    it('should show component', () => {
        cy.mount(
            ...
            {
                imports: [FormsModule, SacFormDirective, SACBootstrap4ContextmenuModule, SACBootstrap4LayoutModule],
                componentProperties: {},
            }
        );
        ...
        cy.contains('div.dropdown-menu button.dropdown-item', 'Action 1').should('exist').should('be.visible');
    });
    ...
    it('should show component with icons in actions', () => {
        ...
        cy.contains('div.dropdown-menu button.dropdown-item', 'Action 1').should('exist').should('be.visible');
        cy.get('div.dropdown-menu button.dropdown-item img[src="/assets/icons/icon.png"]')
            .should('exist')
            .should('be.visible');

        cy.get('div.dropdown-menu sac-contextmenubutton:last-child button').should('not.have.descendants', 'img');
        cy.get('div.dropdown-menu sac-contextmenubutton:last-child button div div').should('have.length', 2);
    });
    ...
    it('should show component without icons colum', () => {
        ...
        cy.contains('div.dropdown-menu button.dropdown-item', 'Action 1').should('exist').should('be.visible');
        cy.get('div.dropdown-menu button.dropdown-item img[src="/assets/icons/icon.png"]').should('not.exist');

        cy.get('div.dropdown-menu sac-contextmenubutton:last-child button').should('not.have.descendants', 'img');
        cy.get('div.dropdown-menu sac-contextmenubutton:last-child button div div').should('have.length', 1);
    });
    ...
    it('should show component with splitter', () => {
        ...
        cy.get('div.dropdown-menu div.dropdown-divider').should('have.length', 1);
    });
