...
describe('SacDateComponent', () => {
    ...
    it('should reset date via selector with focus', () => {
        cy.mount(
            ...
            {
                declarations: [SacFormDirective],
                imports: [FormsModule, SACBootstrap4DateTimeModule, SACBootstrap4LayoutModule],
                componentProperties: {
                    label: 'My Label',
                    value: new Date(2025, 12 - 1, 5), // Month is Index and not Month Value
                    valueChange: createOutputSpy('valueSpy'),
    ...
    it('should reset date via selector with reactive forms', () => {
        ...
        cy.mount(
            ...
            {
                declarations: [SacFormDirective],
                imports: [ReactiveFormsModule, SACBootstrap4DateTimeModule, SACBootstrap4LayoutModule],
                componentProperties: {
                    label: 'My Label',
                    value: form,
                    valueChange: createOutputSpy('valueSpy'),
