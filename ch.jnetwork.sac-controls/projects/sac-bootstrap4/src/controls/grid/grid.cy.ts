...
describe('SacGridComponent', () => {
    it('should show label and component', () => {
        cy.mount(
            ...
            </form>`,
            {
                ...
                imports: [FormsModule, SACBootstrap4GridModule, SACBootstrap4LayoutModule, SACCommonUtliltiesModule],
                componentProperties: {
                    values: [],
                },
            }
    ...
    it('should hide column with ngif', () => {
        cy.mount(
            ...
            {
                declarations: [SacFormDirective],
                imports: [FormsModule, SACBootstrap4GridModule, SACBootstrap4LayoutModule],
                componentProperties: {
                    values: [
                        { Id: 1, Image: 'Bild 1' },
                        { Id: 2, Image: 'Bild 2' },
