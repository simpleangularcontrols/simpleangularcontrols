    ...
    it('should show label and component', () => {
        cy.mount(
            ...
            </form>`,
            {
                ...
                imports: [FormsModule, SACBootstrap4TinyMceModule, SACBootstrap4LayoutModule, SACCommonUtliltiesModule],
                componentProperties: {
                    label: 'My Label',
                    config: {
