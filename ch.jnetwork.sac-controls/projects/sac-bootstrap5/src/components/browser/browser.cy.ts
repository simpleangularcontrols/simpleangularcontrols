...
import { SACBootstrap5LayoutModule } from '../../controls/layout/layout.module';
import { SACBootstrap5BrowserModule } from './browser.module';
...
describe('SacBrowserComponent', () => {
    it('base test', () => {
        cy.registerBrowserBackend(0).then(() => {
            cy.mount(
                ...
                {
                    imports: [FormsModule, SacFormDirective, SACBootstrap5BrowserModule, SACBootstrap5LayoutModule],
                    componentProperties: {},
                }
            );
    ...
    it('should load structure from server if refresh', () => {
        cy.registerBrowserBackend(0).then(() => {
            ...
            cy.contains('ul.dropdown-menu li button.dropdown-item', 'Aktualisieren').should('exist');
            cy.contains('ul.dropdown-menu li button.dropdown-item', 'Aktualisieren').click();
            cy.wait('@getnodes');
        });
    });
    ...
    it('should send delete request on delete folder', () => {
        cy.registerBrowserBackend(0).then(() => {
            ...
            cy.get('li.list-group-item-secondary div.dropdown').click();
            cy.contains('ul.dropdown-menu li button.dropdown-item', 'Löschen').should('exist');
            cy.contains('ul.dropdown-menu li button.dropdown-item', 'Löschen').click();
    ...
    it('should send newfolder request on new folder when press enter', () => {
        cy.registerBrowserBackend(0).then(() => {
            ...
            cy.get('li.list-group-item-secondary div.dropdown').click();
            cy.contains('ul.dropdown-menu li button.dropdown-item', 'Neuer Ordner').should('exist');
            cy.contains('ul.dropdown-menu li button.dropdown-item', 'Neuer Ordner').click();
