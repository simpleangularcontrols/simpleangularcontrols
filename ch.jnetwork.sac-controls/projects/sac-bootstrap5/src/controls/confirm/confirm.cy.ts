...
import { SACBootstrap5ConfirmModule } from './confirm.module';
...
describe('ServiceConfirm', () => {
    it('opens dialog via service and returns the clicked button key', () => {
        ...
        cy.mount(HostComponent, {
            ...
            imports: [FormsModule, SACBootstrap5ConfirmModule, SACBootstrap5LayoutModule, SACCommonUtliltiesModule],
            providers: [
                ServiceConfirm,
                {
