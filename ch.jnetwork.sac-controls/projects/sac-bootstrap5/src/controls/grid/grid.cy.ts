...
describe('SacGridComponent', () => {
    it('should show label and component', () => {
        cy.mount(
            ...
            </form>`,
            {
                ...
                imports: [FormsModule, SACBootstrap5GridModule, SACBootstrap5LayoutModule, SACCommonUtliltiesModule],
                componentProperties: {
                    values: [],
                },
            }
    ...
    it('should have context class at row', () => {
        ...
        cy.get('table').should('exist');
        cy.get('table tr td').eq(0).should('have.class', 'table-success');
        cy.get('table tr td').eq(2).should('have.class', 'table-success');
        cy.get('table tr td').eq(3).should('not.have.class', 'table-success');
        cy.get('table tr td').eq(5).should('not.have.class', 'table-success');
        cy.get('table tr td').eq(6).should('have.class', 'table-info');
        cy.get('table tr td').eq(8).should('have.class', 'table-info');
    });
    ...
    it('should hide column with ngif', () => {
        cy.mount(
            ...
            {
                declarations: [SacFormDirective],
                imports: [FormsModule, SACBootstrap5GridModule, SACBootstrap5LayoutModule],
                componentProperties: {
                    values: [
                        { Id: 1, Image: 'Bild 1' },
                        { Id: 2, Image: 'Bild 2' },
