...
describe('ngInputCurrencyComponent', () => {
    it('should show label and text', () => {
      ...
      <sac-inputcurrency name="field" [label]="label" [ngModel]="value" (ngModelChange)="valueChange.emit($event)">
            ...
            {
                imports: [FormsModule, SacFormDirective, SacInputCurrencyComponent, SACBootstrap5LayoutModule],
                componentProperties: {
                    label: 'My Label',
                    value: 1.33,
    ...
    it('should has e2 testkey with name', () => {
        cy.mount(
            `<form>
                  <sac-inputcurrency name="myControl" label="my Label">
                  </sac-inputcurrency>
              </form>`,
            {
                imports: [FormsModule, SacFormDirective, SacInputCurrencyComponent, SACBootstrap5LayoutModule],
    ...
    it('should has e2 testkey with testidentifier when name exists', () => {
        cy.mount(
            `<form>
                  <sac-inputcurrency name="myControl" e2eidentifier="myTestidentifier" label="my Label">
                  </sac-inputcurrency>
              </form>`,
            {
                imports: [FormsModule, SacFormDirective, SacInputCurrencyComponent, SACBootstrap5LayoutModule],
    ...
    it('should has e2 testkey with testidentifier when name not exists', () => {
        cy.mount(
            `<form>
                  <sac-inputcurrency e2eidentifier="myTestidentifier" label="my Label">
                  </sac-inputcurrency>
              </form>`,
            {
                imports: [FormsModule, SacFormDirective, SacInputCurrencyComponent, SACBootstrap5LayoutModule],
    ...
    it('should not has e2 testkey with name', () => {
        cy.mount(
            `<form>
                  <sac-inputcurrency label="my Label">
                  </sac-inputcurrency>
              </form>`,
            {
                imports: [FormsModule, SacFormDirective, SacInputCurrencyComponent, SACBootstrap5LayoutModule],
    ...
    it('should have floating label with component property', () => {
        cy.mount(
            `<form>
                <sac-inputcurrency name="field" [label]="label" labelMode="floating" placeholder="My Placeholder" [ngModel]="value" (ngModelChange)="valueChange.emit($event)">
                </sac-inputcurrency>
            </form>`,
            {
                imports: [FormsModule, SacFormDirective, SacInputCurrencyComponent, SACBootstrap5LayoutModule],
