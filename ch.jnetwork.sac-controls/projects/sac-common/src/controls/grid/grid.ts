...
import { ChangeDetectorRef, Directive, EventEmitter, Injector, Input, Output, TemplateRef } from '@angular/core';
...
export abstract class SacGridCommon {
     ...
     */
    @Output() public paging: EventEmitter<PagerRequest> = new EventEmitter<PagerRequest>();
     ...
     */
    @Output() public sorting: EventEmitter<SortDescriptor> = new EventEmitter<SortDescriptor>();
