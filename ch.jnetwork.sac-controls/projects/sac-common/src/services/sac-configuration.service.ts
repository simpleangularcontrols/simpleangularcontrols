 ...
 */
export const SACCONFIGURATION_SERVICE = new InjectionToken<ISacConfigurationService>('SacConfigurationService');
...
export abstract class SacAbstractConfigurationService implements ISacConfigurationService {
