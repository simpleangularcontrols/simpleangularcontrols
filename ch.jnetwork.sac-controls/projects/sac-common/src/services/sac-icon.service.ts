...
export abstract class SacAbstractIconService implements ISacIconService {
     ...
     * @inheritdoc
     */
    public abstract get TreeviewNodeActionIcon(): string;

    /**
     * @inheritdoc
     */
    public abstract get TreeviewNodeClosedIcon(): string;

    /**
     * @inheritdoc
     */
    public abstract get TreeviewNodeEmptyIcon(): string;

    /**
     * @inheritdoc
     */
    public abstract get TreeviewNodeOpenIcon(): string;
...
export class SacDefaultIconService extends SacAbstractIconService {
     ...
     * @inheritdoc
     */
    public get TreeviewNodeActionIcon(): string {
        return 'fa fa-pen';
    }
     ...
     * @inheritdoc
     */
    public get TreeviewNodeClosedIcon(): string {
        return 'fa fa-folder-plus';
    }
     ...
     * @inheritdoc
     */
    public get TreeviewNodeEmptyIcon(): string {
        return 'fa fa-folder';
    }
     ...
     * @inheritdoc
     */
    public get TreeviewNodeOpenIcon(): string {
        return 'fa fa-folder-open';
    }
