...
export class SacDefaultLocalisationService extends SacAbstractLocalisationService {
    ...
    constructor(
        ...
        // Validation
        this.data.get('de').set(validationKeyService.ValidationErrorRequired, this.VALIDATION_ERROR_REQUIRED.get('de'));
        this.data
            .get('de')
            .set(validationKeyService.ValidationErrorSummaryRequired, this.VALIDATION_ERROR_SUMMARY_REQUIRED.get('de'));
        this.data.get('de').set(validationKeyService.ValidationErrorMinValue, this.VALIDATION_ERROR_MINVALUE.get('de'));
        this.data
            .get('de')
            .set(validationKeyService.ValidationErrorSummaryMinValue, this.VALIDATION_ERROR_SUMMARY_MINVALUE.get('de'));
        this.data.get('de').set(validationKeyService.ValidationErrorPattern, this.VALIDATION_ERROR_PATTERN.get('de'));
        this.data
            .get('de')
            .set(validationKeyService.ValidationErrorSummaryPattern, this.VALIDATION_ERROR_SUMMARY_PATTERN.get('de'));
        this.data.get('de').set(validationKeyService.ValidationErrorMaxValue, this.VALIDATION_ERROR_MAXVALUE.get('de'));
        this.data
            .get('de')
            .set(validationKeyService.ValidationErrorSummaryMaxValue, this.VALIDATION_ERROR_SUMMARY_MAXVALUE.get('de'));
        this.data.get('de').set(validationKeyService.ValidationErrorEmail, this.VALIDATION_ERROR_EMAIL.get('de'));
        this.data
            .get('de')
            .set(validationKeyService.ValidationErrorSummaryEmail, this.VALIDATION_ERROR_SUMMARY_EMAIL.get('de'));
        this.data
            .get('de')
            .set(validationKeyService.ValidationErrorMinTextLength, this.VALIDATION_ERROR_MINTEXTLENGTH.get('de'));
        this.data
            .get('de')
            .set(
                validationKeyService.ValidationErrorSummaryMinTextLength,
                this.VALIDATION_ERROR_SUMMARY_MINTEXTLENGTH.get('de')
            );
        this.data.get('de').set(validationKeyService.ValidationErrorMinDate, this.VALIDATION_ERROR_MINDATE.get('de'));
        this.data
            .get('de')
            .set(validationKeyService.ValidationErrorSummaryMinDate, this.VALIDATION_ERROR_SUMMARY_MINDATE.get('de'));
        this.data.get('de').set(validationKeyService.ValidationErrorMaxDate, this.VALIDATION_ERROR_MAXDATE.get('de'));
        this.data
            .get('de')
            .set(validationKeyService.ValidationErrorSummaryMaxDate, this.VALIDATION_ERROR_SUMMARY_MAXDATE.get('de'));
        this.data.get('de').set(validationKeyService.ValidationErrorMinTime, this.VALIDATION_ERROR_MINTIME.get('de'));
        this.data
            .get('de')
            .set(validationKeyService.ValidationErrorSummaryMinTime, this.VALIDATION_ERROR_SUMMARY_MINTIME.get('de'));
        this.data.get('de').set(validationKeyService.ValidationErrorMaxTime, this.VALIDATION_ERROR_MAXTIME.get('de'));
        this.data
            .get('de')
            .set(validationKeyService.ValidationErrorSummaryMaxTime, this.VALIDATION_ERROR_SUMMARY_MAXTIME.get('de'));
        this.data
            .get('de')
            .set(validationKeyService.ValidationErrorDatetimeFormat, this.VALIDATION_ERROR_DATETIMEFORMAT.get('de'));
        this.data
            .get('de')
            .set(
        ...
        this.data.get('de').set(validationKeyService.ValidationErrorFilesMin, this.VALIDATION_ERROR_FILESMIN.get('de'));
        this.data
            .get('de')
            .set(validationKeyService.ValidationErrorSummaryFilesMin, this.VALIDATION_ERROR_SUMMARY_FILESMIN.get('de'));
        this.data
            .get('de')
            .set(
        ...
        // Grid Component
        this.data.get('de').set(validationKeyService.PagingPageOf, this.PAGING_PAGEOFTEXT.get('de'));
        this.data.get('de').set(validationKeyService.PagingEntries, this.PAGING_PAGEENTRIESTEXT.get('de'));

        // Upload Component
        this.data.get('de').set(validationKeyService.UploadNoFilesSelected, this.UPLOAD_NO_FILE_SELECTED.get('de'));
        this.data.get('de').set(validationKeyService.UploadButtonUpload, this.UPLOAD_BUTTON_UPLOAD.get('de'));
        this.data.get('de').set(validationKeyService.UploadButtonBrowse, this.UPLOAD_BUTTON_BROWSE.get('de'));

        // TinyMCE Component
        this.data.get('de').set(validationKeyService.TinyMceFileselectOk, this.TINYMCE_FILESELECT_OK.get('de'));
        this.data.get('de').set(validationKeyService.TinyMceFileselectCancel, this.TINYMCE_FILESELECT_CANCEL.get('de'));
        this.data
            .get('de')
            .set(validationKeyService.TinyMceFileselectDialogtitle, this.TINYMCE_FILESELECT_DIALOGTITLE.get('de'));

        // Confirm Dialog Component
        this.data.get('de').set(validationKeyService.ConfirmDefaultButtonYes, this.CONFIRM_BUTTON_YES.get('de'));
        this.data.get('de').set(validationKeyService.ConfirmDefaultButtonNo, this.CONFIRM_BUTTON_NO.get('de'));

        // Browser Component
        this.data.get('de').set(validationKeyService.FilebrowserGridNoFiles, this.FILEBROWSER_NO_FILES.get('de'));
        this.data.get('de').set(validationKeyService.FilebrowserGridFilename, this.FILEBROWSER_GRID_FILE.get('de'));
        this.data.get('de').set(validationKeyService.FilebrowserGridSize, this.FILEBROWSER_GRID_SIZE.get('de'));
        this.data.get('de').set(validationKeyService.FilebrowserButtonUpload, this.FILEBROWSER_UPLOAD.get('de'));
        this.data.get('de').set(validationKeyService.FilebrowserButtonNewFolder, this.FILEBROWSER_NEWFOLDER.get('de'));
        this.data.get('de').set(validationKeyService.FilebrowserButtonRefresh, this.FILEBROWSER_REFRESH.get('de'));
        this.data.get('de').set(validationKeyService.FilebrowserButtonDelete, this.FILEBROWSER_DELETE.get('de'));
        this.data
            .get('de')
            .set(
    ...
    protected get FILEBROWSER_CONFIRM_DELETEFOLDER(): Map<string, string> {
        return new Map<string, string>([['de', 'Soll der Ordner gelöscht werden?']]);
    }
    ...
    protected get FILEBROWSER_UPLOAD(): Map<string, string> {
        return new Map<string, string>([['de', 'Legen Sie Dateien hier ab um Sie hochzuladen']]);
    }
    ...
    protected get PAGING_PAGEOFTEXT(): Map<string, string> {
        return new Map<string, string>([['de', 'Seite {{CURRENTPAGE}} von {{TOTALPAGES}}']]);
    }
    ...
    protected get VALIDATION_ERROR_FILESMIN(): Map<string, string> {
        return new Map<string, string>([['de', 'Es müssen min. {{MINFILES}} Dateien hochgeladen sein.']]);
    }

    protected get VALIDATION_ERROR_MAXDATE(): Map<string, string> {
        return new Map<string, string>([['de', 'Feld muss älter oder gleich {{MAXDATE}} sein.']]);
    }

    protected get VALIDATION_ERROR_MAXTIME(): Map<string, string> {
        return new Map<string, string>([['de', 'Feld muss älter oder gleich {{MAXTIME}} sein.']]);
    }

    protected get VALIDATION_ERROR_MAXVALUE(): Map<string, string> {
        return new Map<string, string>([['de', 'Feld "{{FIELD}}" darf nicht grösser als {{MAXVALUE}} sein.']]);
    }

    protected get VALIDATION_ERROR_MINDATE(): Map<string, string> {
        return new Map<string, string>([['de', 'Feld muss neuer oder gleich {{MINDATE}} sein.']]);
    }

    protected get VALIDATION_ERROR_MINTEXTLENGTH(): Map<string, string> {
        return new Map<string, string>([['de', 'Feld erfordert min. {{MINTEXTLENGTH}} Zeichen.']]);
    }

    protected get VALIDATION_ERROR_MINTIME(): Map<string, string> {
        return new Map<string, string>([['de', 'Feld muss neuer oder gleich {{MINTIME}} sein.']]);
    }

    protected get VALIDATION_ERROR_MINVALUE(): Map<string, string> {
        return new Map<string, string>([['de', 'Wert darf nicht kleiner als {{MINVALUE}} sein.']]);
    }

    protected get VALIDATION_ERROR_MULTILANGUAGEREQUIRED(): Map<string, string> {
        return new Map<string, string>([['de', 'Es müssen alle Sprachen erfasst sein.']]);
    }

    protected get VALIDATION_ERROR_MULTILANGUAGEREQUIREDANY(): Map<string, string> {
        return new Map<string, string>([['de', 'Es muss min. 1 Sprache erfasst sein.']]);
    }

    protected get VALIDATION_ERROR_PATTERN(): Map<string, string> {
        return new Map<string, string>([['de', 'Wert entspricht nicht der Format Vorlage.']]);
    }
    ...
    protected get VALIDATION_ERROR_SUMMARY_DATETIMEFORMAT(): Map<string, string> {
        return new Map<string, string>([['de', 'Feld "{{FIELD}}" ist kein gültiges Datum.']]);
    }

    protected get VALIDATION_ERROR_SUMMARY_EMAIL(): Map<string, string> {
        return new Map<string, string>([['de', 'Feld "{{FIELD}}" ist keine E-Mail Adresse']]);
    }

    protected get VALIDATION_ERROR_SUMMARY_FILESMIN(): Map<string, string> {
        return new Map<string, string>([['de', 'Feld "{{FIELD}}" muss min. {{MINFILES}} Dateien hochgeladen haben.']]);
    }

    protected get VALIDATION_ERROR_SUMMARY_MAXDATE(): Map<string, string> {
        return new Map<string, string>([['de', 'Feld "{{FIELD}}" muss älter oder gleich {{MAXDATE}} sein.']]);
    }

    protected get VALIDATION_ERROR_SUMMARY_MAXTIME(): Map<string, string> {
        return new Map<string, string>([['de', 'Feld "{{FIELD}}" muss älter oder gleich {{MAXTIME}} sein.']]);
    }

    protected get VALIDATION_ERROR_SUMMARY_MAXVALUE(): Map<string, string> {
        return new Map<string, string>([['de', 'Wert darf nicht grösser als {{MAXVALUE}} sein.']]);
    }

    protected get VALIDATION_ERROR_SUMMARY_MINDATE(): Map<string, string> {
        return new Map<string, string>([['de', 'Feld "{{FIELD}}" muss neuer oder gleich {{MINDATE}} sein.']]);
    }

    protected get VALIDATION_ERROR_SUMMARY_MINTEXTLENGTH(): Map<string, string> {
        return new Map<string, string>([['de', 'Feld "{{FIELD}}" erfordert min. {{MINTEXTLENGTH}} Zeichen.']]);
    }

    protected get VALIDATION_ERROR_SUMMARY_MINTIME(): Map<string, string> {
        return new Map<string, string>([['de', 'Feld "{{FIELD}}" muss neuer oder gleich {{MINTIME}} sein.']]);
    }

    protected get VALIDATION_ERROR_SUMMARY_MINVALUE(): Map<string, string> {
        return new Map<string, string>([['de', 'Feld "{{FIELD}}" darf nicht kleiner als {{MINVALUE}} sein.']]);
    }

    protected get VALIDATION_ERROR_SUMMARY_MULTILANGUAGEREQUIRED(): Map<string, string> {
        return new Map<string, string>([['de', 'Feld "{{FIELD}}" muss alle Sprachen erfasst haben.']]);
    }

    protected get VALIDATION_ERROR_SUMMARY_MULTILANGUAGEREQUIREDANY(): Map<string, string> {
        return new Map<string, string>([['de', 'Feld "{{FIELD}}" muss min. 1 Sprache erfasst haben.']]);
    }

    protected get VALIDATION_ERROR_SUMMARY_PATTERN(): Map<string, string> {
        return new Map<string, string>([['de', 'Feld "{{FIELD}}" entspricht nicht der Format Vorlage.']]);
    }

    protected get VALIDATION_ERROR_SUMMARY_REQUIRED(): Map<string, string> {
        return new Map<string, string>([['de', 'Feld "{{FIELD}}" ist erforderlich.']]);
    }
